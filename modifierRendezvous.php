...
if (isset($_POST['modifier'])){
  $Rendezvous=new Rendezvous($_POST['Nom'],$_POST['Prenom'],$_POST['Email'],$_POST['Adresse'],$_POST['Gouvernorat'],$_POST['Ville'],$_POST['CodePostal'],$_POST['Telephone']);
  $RendezvousC->modifierRendezvous($Rendezvous,$_POST['id']);
  echo $_POST['id'];
 echo ("<script LANGUAGE='JavaScript'>window.location.href='rendezvous.php';</script>");
