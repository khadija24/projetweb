...
$listeRendezvous=$RendezvousC->afficherRendezvous();
        ...
        <div class="row">
          <div class="col-lg-9 main-chart">
            ...
            <div class="border-head">
              <h3>Rendez-vous installation</h3>
            </div>
...
foreach($listeRendezvous as $row){
  ...
  <td><form method="POST" action="../views/supprimerRendezvous.php">
  
  <input type="submit" name="supprimer"  class="btn btn-danger"  value="supprimer">
  <input type="hidden" value="<?PHP echo $row['id']; ?>" name="id">
  </form>
  </td>
  <td><a href="modifierRendezvous.php?id=<?PHP echo $row['id']; ?>" style="text-decorations:none; color:white;"  class="btn btn-warning">
  Modifier</a></td>
  </tr>
  <?PHP
}
